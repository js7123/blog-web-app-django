...
2. Activate the virtual environment.
   ...
   ```
3. Checkout the project from Github to a local directory.
4. As mention in the prerequisites section, prior to running the server please provide Django secret key value in the _blogsite\blogsite\settings.py_ file :
   ```
   SECRET_KEY = '<django-secret-key>'
   ```
...
6. Start the server. Sample command:
   ...
   ```
7. For examples of the activities supported by this blog web application please see _"Site Administration"_, _"Adding a blog post"_ and _"Viewing blog posts"_ sections below.
